namespace RVAS_Stripovi.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Colored = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Rentals", "ComicBookId", "dbo.ComicBooks");
            DropForeignKey("dbo.ComicBooks", "GenreId", "dbo.Genres");
            ...
            DropIndex("dbo.Rentals", new[] { "ComicBookId" });
            DropIndex("dbo.ComicBooks", new[] { "GenreId" });
